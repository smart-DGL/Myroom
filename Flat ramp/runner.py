...
# 设置日志
log_file = 'C:/Users/Mr.D/Desktop/Graduation thesis/Flat ramp/Flat ramp training_log.log'
config_path = 'C:/Users/Mr.D/Desktop/Graduation thesis/Flat ramp/Flat ramp.sumocfg'
...
def main():
    ...
    # 确保所有参数适配
    ppo = PPO(state_dim=8, lr=0.0001, betas=(0.9, 0.999), gamma=0.9, K_epochs=4, eps_clip=0.1, device=device,
              action_std=0.1)
    epoch = 1  # 初始化训练轮次
            ...
            if 'ego' in traci.vehicle.getIDList():
                ...
                if current_road == "lane2":
                    ...
                    if traci.vehicle.getLanePosition("ego") >= 50:
                        ...
                        sim_control.observation = np.empty(8)  # 状态空间为9
